...
(function() {
  ...
  */
  ...
  NodeBuilder = (function() {
    function NodeBuilder(schemaPath) {
      this._addParentChildEdges = __bind(this._addParentChildEdges, this);      this._schemaPath = schemaPath;
      this._nodes = [];
    }

    NodeBuilder.prototype.init = function() {
      this._nodeConfigs = require(this._schemaPath);
      return this._build();
    };
